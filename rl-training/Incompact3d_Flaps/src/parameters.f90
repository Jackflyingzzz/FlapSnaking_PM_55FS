...
open(10,file='alpha_transitions.prm',status='unknown',form='formatted') ! Load the flap angles at the beginning and the end of the solver
read (10, *) alfat_transition(1) ! Top flap start
read (10, *) alfat_transition(2) ! Top flap end
read (10, *) alfab_transition(1) ! Bottom flat start
read (10, *) alfab_transition(2) ! Bottom flat end
close(10)
