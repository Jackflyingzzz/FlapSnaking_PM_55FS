...
!                  --> nm = n  
!                  --> m  = n + 2
integer,parameter :: nx=513,ny=384,nz=1
...
!new_IBM : 
integer,parameter               :: nraf=1,nobjmax=20
...
module param
  ...
  real(8), dimension(2) :: alfat_transition, alfab_transition
end module param
...
module IBM
  ...
  real(8) :: amax, freq, length, thick, aspec
  integer :: flap, angexc, geoah
end module IBM
