...
if __name__ == '__main__':
    ...
    saver_restore = os.path.join(cwd, 'saver_data/TQC_Flaps_Model_FreeMoving_119040_steps.zip')
    vecnorm_path = os.path.join(cwd, 'saver_data/TQC_Flaps_Model_FreeMoving_vecnormalize_119040_steps.pkl')
